...
const Work = () => {
  return (
    <div name='work' className= ' w-full bg-[#0a192f] text-gray-300 md:h-screen'>
        <div className='max-w-[1000px] mx-auto flex flex-col justify-center w-full h-screen p-4'>
            <div className='pb-8'>
            ...
            <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-4'>
                ...
                className='shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div'>
                    ...
                    {/* hovereffect */}
                    <div className='opacity-0 group-hover:opacity-100 text-center duration-100'>
